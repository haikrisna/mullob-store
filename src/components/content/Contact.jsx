...
import { InstagramLogoIcon, TiktokLogoIcon, WhatsappLogoIcon } from "@phosphor-icons/react"
        ...
        <div className="bg-gray-50 py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <div className="text-center mb-12">
              <h2 className="text-4xl font-bold text-gray-800 mb-2">LET'S TALK</h2>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              {/* Store Information */}
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-6">Mullob Store</h3>
              ...
              {/* Social Media */}
              <div>
                <h3 className="text-xl font-semibold text-gray-800 mb-6">Social</h3>
                ...
                {/* Follow us text */}
                <div className="mt-6">
                  <p className="text-gray-600 text-sm">Follow us untuk update produk terbaru dan tips hidup sehat!</p>
                </div>
              </div>
            </div>
