...
const LayoutCard = ({ 
  ...
  return (
    <Card className={`overflow-hidden bg-green-50 border-green-200 ${className}`}>
...
const ContentLayoutCard = ({ 
  ...
  return (
    <Card className={`overflow-hidden bg-white border-gray-200 hover:shadow-md transition-shadow ${className}`}>
      <CardContent className="p-6">
        <div className="flex items-start gap-4">
          {/* Image/Icon Section */}
          <div className="flex-shrink-0">
  ...
  const sampleData = [
    {
      ...
      description: "Streamline your workflow with our comprehensive project management solution.",
    },
    {
      title: "Analytics Dashboard",
      subtitle: "Business Intelligence • Updated yesterday",
      description: "Get insights from your data with powerful visualization and reporting tools.",
    },
    {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 space-y-6">
      ...
      <div className="space-y-4">
        ...
        <p className="text-gray-600">Real content examples with the same layout:</p>
        <div className="space-y-4">
